...
from tasks import blood_analysis, report_verification, nutrition_analysis, exercise_planning
...
def run_crew(query: str, file_path: str="data/sample.pdf"):
    ...
    medical_crew = Crew(
        ...
        tasks=[blood_analysis, report_verification, nutrition_analysis, exercise_planning],
